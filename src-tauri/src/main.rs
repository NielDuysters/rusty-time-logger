...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![tauri_commands::play, tauri_commands::save,  tauri_commands::delete_task, tauri_commands::create_new_project, tauri_commands::load_projects, tauri_commands::delete_project, tauri_commands::select_project, tauri_commands::update_finished_tasks, tauri_commands::exit])
